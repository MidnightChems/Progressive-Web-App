...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <li>Clean using Viper Neutral Stone Cleaner or Stone Perfect and SX-15, Gekko wand or similar tools. Agitation with scrub brush may be helpful. This will remove most stains from tile, grout and well-maintained stone.</li>

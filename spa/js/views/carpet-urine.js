...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <li>Dry Vacuum (do not rinse) to remove excess urine.</li>
            <li>Apply Urine Stain Remover as final step.</li>
            <li>Allow to dry naturally and stain will disappear in 1 to 8 hours.</li>
            <p>Note: If urine has saturated into the backing and pad, apply a heavy dose of Urine Stain Remover followed by flushing using a Spot Claw or Flash Extractor.<p>
            </ol> 
            </div>
        `;
    }

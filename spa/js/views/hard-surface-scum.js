...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <p>If these deposits persist after normal cleaning procedure with Viper Neutral Stone Cleaner or Stone Perfect, it will be necessary to do a restorative cleaning using Viper Renew or Viper Resuscitate followed by polishing the affected areas.</p>
            ...
            <li>Rinse with Viper Stone Perfect or Viper Neutral Stone Cleaner at 1:32</li>
            ...
            <li>Seal with Prestige Impregnating Sealers. Multiple coats may be needed.</li>     
            </ol> 
            </div>
        `;
    }

...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <li>Patiently, use a bone scraper for gentle agitation to break into pieces and vacuum up as much as possible.  Rinse with water if evident other chemicals have been used.</li>
            <li>Apply Avenge Pro Spotter to the affected area. Work into stain producing foam. Foam containing contaminants can be removed by blotting with towel or flat edge of bone scraper used as a squeegee.</li>

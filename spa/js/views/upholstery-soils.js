...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            ...
            <li>CAUTION: This step can weaken some natural fibers. Proceed with client's informed consent. If color remains, Apply RedZONE Ready. Allow up to 20 minutes dwell time. Rinse and extract with hot water.</li>
